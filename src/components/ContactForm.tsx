    ...
    <section id="contacts" className="w-full bg-gray-50 py-6">
      <div className="container-custom pt-(--header-height)">
        <div>
          ...
          <div className="space-y-5 grid grid-cols-2 gap-20">
            {/* PHONE */}
            <a
            ...
            <a
              ...
              className="group flex items-start gap-4 p-5 rounded-2xl bg-white border border-gray-200 hover:border-[#16b5da] transition-all duration-300 mb-5"
            >
              <div className="w-12 h-12 rounded-xl bg-[#16b5da]/10 flex items-center justify-center shrink-0">
